...
public class CommercialCustomerTrackWaterUsageJPanel extends javax.swing.JPanel {
    ...
    private void populateStorageTankTable()
   {
    ...
    private void initComponents() {
        ...
        viewDetailsBtn.setFont(new java.awt.Font("Copperplate Gothic Light", 1, 16)); // NOI18N
    ...
    private void viewDetailsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailsBtnActionPerformed
        // TODO add your handling code here:
        Map<Date,String> map=account.getCustomer().getConsumer().getTrackWaterUsageMap();
        for (Date da: map.keySet()){

            String key =da.toString();
            String value = map.get(da).toString();
            System.out.println(key + " " + value);  }

        System.out.println("Total Utilization :"+(account.getCustomer().getRainWaterTankUtilization()+account.getCustomer().getStorageTankUtilization()));
        System.out.println("RainWaterTank Utilization :"+account.getCustomer().getRainWaterTankUtilization());
        System.out.println("StorageTank Utilization :"+account.getCustomer().getStorageTankUtilization());
