...
public class PredictiveAnalysisJPanel extends javax.swing.JPanel {
    ...
    public PredictiveAnalysisJPanel(JPanel userProcessContainer, EcoSystems system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        residentialTotalRequirementLabel.setText("<value>");

        residentialRainWaterContributionLabel.setText("<value>");

        residentialStorageContributionLabel.setText("<value>");
        ...
        commerciallTotalRequirementLabel.setText("<value>");

        jLabel13.setText("Contribution by Rain Water Harvesting Tank");

        commercialRainWaterContributionLabel.setText("<value>");

        jLabel14.setText("Contribution by Storage  Tank");

        commercialStorageContributionLabel.setText("<value>");
        ...
        overalllTotalRequirementLabel.setText("<value>");

        jLabel16.setText("Contribution by Rain Water Harvesting Tank");

        overallRainWaterContributionLabel.setText("<value>");

        jLabel17.setText("Contribution by Storage  Tank");

        overallStorageContributionLabel.setText("<value>");
    ...
    private void residentialPredictiveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_residentialPredictiveBtnActionPerformed
       ...
       try{
        ...
        double rainWaterContribution = averageResidentialRainWaterUsage*customerCount +5;
    ...
    private void commercialPredictiveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_commercialPredictiveBtnActionPerformed
        // TODO add your handling code here:
         try{
        if(commercialCustomerCountTxtField.getText().equals("")||residentialDatePicker.getDate().equals(""))
            JOptionPane.showMessageDialog(null, "Entries cannot be null for Prediction", "Warning", JOptionPane.WARNING_MESSAGE);
        else{
        ...
        double rainWaterContribution = averageCommercialRainWaterUsage*customerCount +5;
    ...
    private void overallPredictiveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_overallPredictiveBtnActionPerformed
       ...
       try{
        if(overallCommercialCostomerCountTxtField.getText().equals("")||
                overallResidentialCustomersCountTxtField.getText().equals("")||residentialDatePicker.getDate().equals(""))
            JOptionPane.showMessageDialog(null, "Entries cannot be null for Prediction", "Warning", JOptionPane.WARNING_MESSAGE);
        else{
        ...
        int residentialustomerCount = Integer.parseInt(residentialCustomersCountTxtField.getText());
        ...
        int commercialCustomerCount = Integer.parseInt(commercialCustomerCountTxtField.getText());
        ...
        double residentialRainWaterContribution = averageResidentialRainWaterUsage*residentialustomerCount +5;
        double commercialRainWaterContribution = averageCommercialRainWaterUsage*commercialCustomerCount +5;
